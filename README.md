...
4. Uppdatera din `master` branch genom `git pull origin master`. Om du vill slippa skriva en anledning till varför du gör en merge så skriver du istället `git pull origin master --no-edit`
