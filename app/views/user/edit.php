    ...
    <form method="POST" action="<?php echo BASE_URL . '/user/edit.php?post_id=' . $_GET['post_id'] ?>" class="d-flex mt-2" autocomplete="off">
        <div class="col-md-10">
            <div class="form-group">
                ...
                <input type="text" name="title" id="title" value="<?php echo $page['title']; ?>" class="form-control" maxlength="50" required>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="text" name="tags" id="tags" value="<?php echo $page['tags']; ?>" class="form-control" maxlength="30" required>
            </div>
