        ...
        <div class="row">
            <div class="col-lg-12 col-xs-12">
                <div class="container">
                    ...
                    <div class="alert alert-success" role="alert">User was successfully
                    ...
                    <table class="table table-responsive table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    <a href="<?php echo BASE_URL . '/public/user.php?user_id=' . $user['user_id'];?>">
                                        <?php echo escape($user['username']); ?>
                                    </a>
                                </td>
                                <td>
                                    <?php echo escape($user['firstname']); ?>
                                </td>
                                <td>
                                    <?php echo escape($user['lastname']); ?>
                                </td>
                                <td>
                                    <?php echo escape($user['email']); ?>
                                </td>
                                <td>
                                    <button name='user' class="btn btn-danger delete-btn pointer" data-name="<?php echo $user['username'];?>" data-link="<?php echo BASE_URL . '/user/delete_user.php?user_id=' . $user['user_id'] . '&admin=true'; ?>">Delete</button>
                                </td>
                            </tr>
                            <?php endif ?>
                            <?php endforeach; ?>
